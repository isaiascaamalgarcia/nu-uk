package shary.mysqlsqllitesync;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://192.168.1.68/mysqlsqlitesync/getusers.php", params, new AsyncHttpResponseHandler() {
            @Override
    ...
    public void updateMySQLSyncSts(String json) {
        ...
        client.post("http://192.168.1.68/mysqlsqlitesync/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
