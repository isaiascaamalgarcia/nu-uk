...
import Apriori.EmergenteProduct;
...
//    Carga el diseño de los tabs.
    ...
    private void initComponents() {
        ...
        jButton1.setText("-- Vendidos");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, -1, 30));
...
//    Evento que llama a otro jframe EmergenteEdicionUser.
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        EmergenteProduct emg = new EmergenteProduct();
            emg.setVisible(true);
            emg.setLocationRelativeTo(this);
