...
public class ListadoFechasCampo {
...
//  las columnas, los campos de fecha y campo de busqueda especifica para la consulta mas especifica (con clausula) en la BD.
    public ListadoFechasCampo(String tabla, String columnas, String campoFecha, String campoNombre, String fechaInicio, String fechaFin, String vendedor) {
        this.tabla = tabla;
...
//Realizamos la consulta sql y llenamos los datos en "Object"
        try {
            ...
            pstm = (PreparedStatement) con.conectar().prepareStatement("SELECT "
                    + columnas
                    + " FROM " + tabla + " WHERE " + campoFecha + " BETWEEN '" + fechaInicio
                    + "' AND '" + fechaFin + "' AND " + campoNombre + "='" + vendedor + "';");
