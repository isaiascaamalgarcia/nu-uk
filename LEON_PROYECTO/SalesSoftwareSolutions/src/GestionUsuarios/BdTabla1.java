 ...
 */
//Clase que permite estructurar la tabla de usuarios existentes en la BD desde el arranque, esta clase solo es el
//paso de parámetros para el llenado.
public class BdTabla1 {
...
//    Tiene las columnas de acuerdo a la BD, este método tiene menos columnas.
//    Llama a la clase diseñoTablas y le pasa los parámetros mencionados.
    public BdTabla1(JTable tabla) {
        this.tabla = tabla;
        diseñoTabla = "USUARIO,CONTRASEÑA";
