...
namespace Puzzle
{
    public partial class Form1 : Form
    {
        ...
        private void Initialize()
        {
            ...
            //Declarcion de Clase LinearShuffle
            mShuffle = new LinearShuffle<int>();
            //Declarcion de Clase PuzzleStrategy
            ...
            // Establecer nodos de visualización
            ...
            statusLabel.Text = "Puedes arrastrar y soltar para barajar los azulejos o cuadros...";
            progressBar.Style = ProgressBarStyle.Marquee;
            progressBar.Visible = false;
            manhattanDistanceMenu.Checked = true;
        }

        //Hace referencia a los valores de canje
            ...
            Action action = () =>
                {
                    ...
                    if (steps > -1)
                    {
                        statusLabel.Text = "Pasos: " + steps.ToString("n0") + ", Tiempo: " + (time / 1000.0).ToString("n2") + ", Estados: " + statesExamined.ToString("n0");
                        MessageBox.Show(this, "Solucion Encontrada! Haga clic en Aceptar para ver los pasos...");
                    }
                    else
                    {
                        statusLabel.Text = "Pasos: Ninguno, Tiempo: " + (time / 1000.0).ToString("n3") + "Segundo, Estados: " + statesExamined.ToString("n0");
                        MessageBox.Show(this, "Solucion No Encontrada!");
                    }
                };
        ...
        private void StartSolvingPuzzle()
        {
            ...
            statusLabel.Text = "Encontrar una solución...";
            mBusy = true;
        }
